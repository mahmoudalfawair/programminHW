# this is a programming prject for machine learning course
# by professor Abdelwadood MESLEH
...
for epoch in range(num_epoch):
    ...
    if (epoch % 50 == 1):
        print('Epoch [%d/%d]       Acc: %.4f' % (epoch + 1, num_epoch, acc.item()))
